...
- [x] Replace in-memory persistence with PostgreSQL and Flyway.
- [x] Make order and outbox insert atomic.
- [x] Add concurrent lease-based worker claims.
- [x] Add Kafka/Redpanda publisher.
- [x] Add consumer-side `eventId` deduplication.
- [x] Add commerce event V1 JSON Schema.
